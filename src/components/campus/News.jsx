...
const highlights = [
  { title: 'Scholarships & Financial Aid', desc: 'Merit-based institutional support for the brightest minds across all programmes.', img: img1, link: '/scholarships', tag: 'SUPPORT' },
  { title: 'ICT-Enabled Classrooms', desc: 'Digital-first learning environments equipped with smart boards and AV systems.', img: img2, link: '/ict-classrooms', tag: 'TECH' },
  { title: 'Campus Security', desc: '24/7 CCTV surveillance and dedicated security personnel ensuring absolute safety.', img: img3, link: '/security', tag: 'SAFETY' },
];
    ...
    <section className="relative py-28 md:py-36 overflow-hidden" id="news" style={{ backgroundColor: '#F5EEEC' }}>
      ...
      <div className="max-w-[1400px] mx-auto px-6 xl:px-14 relative z-10">
        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-8">
          ...
          >
            <Link to="/innovation-lab" className="absolute inset-0 z-20" />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-10 md:p-12 z-10 pointer-events-none">
          ...
          <div className="flex flex-col gap-6">
            {highlights.map((item, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group relative flex gap-6 items-center p-5 rounded-[20px] bg-white/60 backdrop-blur-sm hover:bg-white transition-all duration-500 hover:shadow-[0_20px_50px_-20px_rgba(62,58,54,0.15)]"
              >
                ...
                {/* Arrow */}
                <ArrowUpRight size={20} className="text-[#3E3A36]/20 group-hover:text-[#E56D24] transition-all duration-300 group-hover:-translate-y-1 group-hover:translate-x-1 flex-shrink-0 relative z-10" />
              </motion.div>
            ))}
          </div>
        </div>
