      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {programmes.map(({ icon, title, desc, href, delay }) => {
            const LinkWrapper = href.startsWith('/') ? Link : 'a';
            const linkProps = href.startsWith('/') ? { to: href } : { href: href, target: '_blank', rel: 'noopener noreferrer' };
            ...
            return (
              ...
              >
                ...
                <h3 className="font-display font-bold text-lg mb-2 text-[#1A1817]">{title}</h3>
